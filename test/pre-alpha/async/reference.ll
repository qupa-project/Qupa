...
; token %hdl, i8* %contID, i8 %returnID
...
resume:
	...
	switch i8 %cont_from, label %hang [ i8 1, label %hang
		i8 2, label %hang
		i8 3, label %hang
	]
...
callback1:
	%promise1.addr.raw = call i8* @llvm.coro.promise(i8* %8, i32 4, i1 false)
	...
	br label %join
callback2:
	%promise2.addr.raw = call i8* @llvm.coro.promise(i8* %17, i32 4, i1 false)
